...
export default function Home() {
  return (
    <main className="overflow-hidden bg-ivory">
      ...
      <a
        href="https://wa.me/258850573499"
        aria-label="Contactar pelo WhatsApp"
        className="fixed bottom-5 right-5 z-40 grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-2xl text-white shadow-soft transition hover:scale-105"
      >
        ✆
      </a>
    </main>
